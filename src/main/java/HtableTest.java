...
public class HtableTest {
    ...
    public static void init(){
        ...
        conf.addResource(HtableTest.class.getClassLoader().getResource("hbase-site.xml"));
        conf.addResource(HtableTest.class.getClassLoader().getResource("hdfs-site.xml"));
        conf.addResource(HtableTest.class.getClassLoader().getResource("core-site.xml"));
        /*String sasa="com.sun.security.auth.module.Krb5LoginModule required\n" +
                "  useKeyTab=true\n" +
                "  storeKey=true\n" +
                "  useTicketCache=false\n" +
                "  keyTab=\"/etc/hyperbase1/conf/hyperbase.keytab\"\n" +
                "  principal=\"hbase/linux-pm-0-38@TDH\";";
        conf.set("sasl.jaas.config",sasa);
        conf.set("ssl.key.password","123456");
        conf.set("sasl.mechanism","GSSAPI");
        conf.set("security.protocol","SASL_PLAINTEXT");
        conf.set("sasl.kerberos.service.name","hyperbase1");*/
    }
    //安全相关
    public static void loginWithKerberos(String user,String path){
        try {
    ...
    public static void main(String[] args) throws Exception {
        init();
        loginWithKerberos("hbase/linux-pm-0-37@TDH" ,"E:\\\\hyperbase.keytab");
        // 创建表
